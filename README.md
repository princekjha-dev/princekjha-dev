...
|---|---------|-------------|-------|--------|
| 01 | [**RepoChat**](https://github.com/princekjha-dev/repochat) | Full-stack RAG app that turns any public GitHub repo into a conversational knowledge base. AST chunking for Python, semantic search via ChromaDB, source-referenced answers via OpenRouter. | React · Flask · ChromaDB · Sentence Transformers · OpenRouter | [![Live](https://img.shields.io/badge/Live-22c55e?style=flat-square)](https://repo-chat-ochre.vercel.app/) |
| 02 | [**Clipify**](https://github.com/princekjha-dev/Clipify) | CLI tool that extracts viral moments from long-form video using Whisper transcription, audio energy analysis, and configurable scoring. Multi-ratio export (9:16, 16:9, 1:1) with per-clip VTT captions. Supports 8 AI providers + fully offline local mode. | Python · Whisper · FFmpeg · yt-dlp | v1.0.1 |
| 03 | [**Intellidoc**](https://github.com/princekjha-dev/Al-Powered-Office-Document-Automation-System) | Telegram + web platform for grounded document Q&A, comparison, translation, quality scoring, and generation — with anti-hallucination safeguards baked in. | Python · FastAPI · RAG · Telegram | Complete |
| 04 | [**AI Assistant Telegram Bot**](https://github.com/princekjha-dev/AI-Assistant-Telegram-Bot) | Feature-rich Telegram assistant — multi-model chat, personality modes, mood-aware responses, image generation, persistent memory, and gamification. SQLite backend for per-user state. | Python · Telegram Bot API · OpenRouter · SQLite | Complete |
| 05 | [**SecretScan**](https://github.com/princekjha-dev/secretscan) | Context-aware secrets leak scanner for codebases and git history. 17+ patterns, Shannon entropy scoring, 5-rule false-positive suppression engine, HTML/JSON/console reports, pre-commit hook installer. | Java · JGit · Maven | Complete |
